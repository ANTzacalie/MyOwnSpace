// VERSION 1.0 OF MY_OWN_SPACE:
  ...
  /* THINGS TO IMPLEMENT:
      ...
      - MAIN MENU , WHERE MOST STUFF HAPPENS:
          ...
          -- In settings there will be a button to retrieve all data from cloud(server)
              ...
              -- TO DISCONNECT FROM ACCOUNT WHILE IN MAIN , THE USER WILL GO TO SETTINGS AND CLICK ON DISCONNECT;
      - There will be a tree dot icon button in the back of the file name that will open a menu with those 3 options:
        -- ALLOW THE USER TO DOWNLOAD THE FILES LOCALLY,
        -- RENAME THE FILE,
        -- ALLOW THE USER TO DELETE THE FILES ON SERVER

        // TESTED ON WEB/WINDOWS/LINUX/MAC , FILE PICKER WORKS;
        // TESTED ON PHONE , FILE PICKER WORKS
  */